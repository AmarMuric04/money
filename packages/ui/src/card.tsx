...
const StatCard = React.forwardRef<HTMLDivElement, StatCardProps>(
  (
    ...
    <div
      ref={ref}
      className={cn(
        "flex items-center gap-4 p-5 rounded-3xl border bg-card shadow-sm",
        className,
      )}
      {...props}
    >
...
>(
  (
    ...
    <button
      ref={ref}
      className={cn(
        "p-5 bg-card rounded-3xl border shadow-sm hover:shadow-md transition-all text-left group cursor-pointer",
        className,
      )}
      {...props}
    >
      <div className="flex items-center gap-4">
        {icon && (
          <div
            className={cn(
              "h-12 w-12 rounded-2xl flex items-center justify-center group-hover:scale-105 transition-transform",
              iconBg,
            )}
          >
            <div className={iconColor}>{icon}</div>
